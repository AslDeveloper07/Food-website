  ...
  return (
    <div className="flex justify-between items-center container py-[20px]">
      ...
      <div className="flex justify-between items-center gap-6">
        ...
        <button onClick={()=>setShowLogin(true)} className="transparent border border-4-[1px] py-2 px-6 rounded-4xl text-[15px] cursor-pointer hover:bg-orange-100 transition duration-300">
          Sign in
        </button>
      </div>
    </div>
